...
export default function Home() {
  return (
    <>
      ...
      {/* Who We Work With */}
      <section className="py-32 px-8 lg:px-16" style={{ backgroundColor: '#FCFBF8', position: 'relative' }}>
      ...
      {/* The Problem */}
      <section className="py-32 px-8 lg:px-16" style={{ backgroundColor: '#F3F0EA', position: 'relative', borderTop: '1px solid #D6D0CF' }}>
        {/* Subtle texture overlay */}
      ...
      <section className="py-32 px-8 lg:px-16" style={{ backgroundColor: '#FCFBF8', position: 'relative' }}>
        ...
        <div className="max-w-7xl mx-auto relative">
          <p className="text-xs tracking-widest uppercase mb-24" style={{ color: '#5E5954', letterSpacing: '0.15em' }}>Value</p>

          {/* Row 1: Text Left, Image Right */}
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            <div>
              <p style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-2xl lg:text-[2.25rem] leading-relaxed max-w-lg">More cohesive launches lead to higher sell through</p>
            </div>
            <div>
              <img
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            <div className="lg:order-2 order-1">
              <p style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-2xl lg:text-[2.25rem] leading-relaxed max-w-lg">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <p style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-2xl lg:text-[2.25rem] leading-relaxed max-w-lg mb-12">
