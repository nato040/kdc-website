  ...
  return (
    <section className="py-40 px-8 lg:px-16 mt-32" style={{ backgroundColor: '#F3F0EA', position: 'relative' }}>
      ...
      <div className="max-w-4xl mx-auto relative text-center">
        <p className="text-xs tracking-widest uppercase mb-16" style={{ color: '#5E5954', letterSpacing: '0.15em' }}>Contact</p>

        <h2 style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-4xl lg:text-5xl mb-16 leading-tight">
          Select partnerships only.
        </h2>

        <div className="space-y-12 mb-20">
          <p className="text-lg max-w-2xl mx-auto" style={{ color: '#3A342F', fontWeight: 300, lineHeight: '1.8' }}>
          ...
          <a
            ...
            className="text-2xl lg:text-3xl inline-block hover:opacity-60 transition-opacity"
          >
            hello@kennydonna.com
          </a>
        </div>

        <div className="pt-16" style={{ borderTop: '1px solid #D6D0CF' }}>
          <p className="text-xs tracking-widest uppercase mb-8" style={{ color: '#5E5954', letterSpacing: '0.15em' }}>Connect</p>
