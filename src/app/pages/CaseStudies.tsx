  ...
  return (
    <section className="py-40 px-8 lg:px-16 mt-32" style={{ backgroundColor: '#FCFBF8', position: 'relative' }}>
      ...
      <div className="max-w-7xl mx-auto relative">
        <p className="text-xs tracking-widest uppercase mb-12" style={{ color: '#5E5954', letterSpacing: '0.15em' }}>Case Studies</p>
        <h2 style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-4xl lg:text-5xl mb-20 max-w-4xl leading-tight">
          A refined look at results delivered across a range of partners.
        </h2>

        {/* Case Study 1 */}
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-32 pb-32" style={{ borderBottom: '1px solid #D6D0CF' }}>
          <div>
            <img
              src={caseStudy1}
          ...
          <div className="space-y-8 lg:pt-12">
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-3xl lg:text-4xl leading-tight">Campaign Performance</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-32 pb-32" style={{ borderBottom: '1px solid #D6D0CF' }}>
          ...
          <div className="space-y-8 lg:pt-12">
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-3xl lg:text-4xl leading-tight">Email & SMS Growth</h3>
            <p className="text-lg leading-relaxed" style={{ color: '#3A342F', fontWeight: 300, lineHeight: '1.8' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-32 pb-32" style={{ borderBottom: '1px solid #D6D0CF' }}>
          ...
          <div className="space-y-8 lg:pt-12">
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-3xl lg:text-4xl leading-tight">Collection Launches</h3>
            <p className="text-lg leading-relaxed" style={{ color: '#3A342F', fontWeight: 300, lineHeight: '1.8' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8 lg:pt-12">
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-3xl lg:text-4xl leading-tight">Customer Retention</h3>
            <p className="text-lg leading-relaxed" style={{ color: '#3A342F', fontWeight: 300, lineHeight: '1.8' }}>
