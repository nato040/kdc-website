  ...
  return (
    <section className="py-20 sm:py-28 lg:py-40 px-6 sm:px-8 lg:px-16 mt-20 sm:mt-24 lg:mt-32" style={{ backgroundColor: '#F3F0EA', position: 'relative' }}>
      ...
      <div className="max-w-7xl mx-auto relative">
        <p className="text-xs tracking-widest uppercase mb-12 lg:mb-20" style={{ color: '#5E5954', letterSpacing: '0.15em' }}>How We Partner</p>

        {/* Section 1: Text Left, Image Right */}
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center mb-20 lg:mb-40">
          <div className="space-y-6 lg:space-y-8">
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-2xl sm:text-3xl lg:text-4xl leading-tight">Where We Sit</h3>
            <div className="space-y-5 lg:space-y-6 text-base sm:text-lg" style={{ color: '#3A342F', fontWeight: 300, lineHeight: '1.8' }}>
              <p>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div className="lg:order-2 order-1 space-y-6 lg:space-y-8">
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-2xl sm:text-3xl lg:text-4xl leading-tight">KDC System</h3>
            <div className="space-y-5 lg:space-y-6 text-base sm:text-lg" style={{ color: '#3A342F', fontWeight: 300, lineHeight: '1.8' }}>
              <p>
              ...
              <p style={{ fontFamily: 'var(--font-serif)', color: '#171717', fontWeight: 300 }} className="text-xl sm:text-2xl lg:text-3xl pt-4 lg:pt-6">
